...
BOARD_KERNEL_CMDLINE := console=ttyHSL0 androidboot.hardware=shooter no_console_suspend=1 maxkhz=1512000 maxscroff=486000 3dgpu=320000000 2dgpu=266667000 s2w=1 s2w_start=MENU s2w_end=SEARCH
